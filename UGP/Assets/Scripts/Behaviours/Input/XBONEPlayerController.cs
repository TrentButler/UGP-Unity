...
namespace UGP
{
    public class XBONEPlayerController : InputController
    {
        ...
        public void Melee()
        {
            var xbone_left_trigger = Input.GetAxis("xbone_left_trigger");
            var xbone_right_trigger = Input.GetAxis("xbone_right_trigger");

            if (xbone_left_trigger > 0.0f)
            {
